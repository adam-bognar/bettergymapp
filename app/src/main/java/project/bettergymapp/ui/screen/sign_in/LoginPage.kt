...
import project.bettergymapp.data.service.MockAccountService
@Composable
fun LoginPage(
    ...
    Box(
        ...
        TextButton(
            onClick = { viewModel.onSignUpClick(onLoginClick) },
            modifier = Modifier
...
fun LoginPagePreview() {
    val mockAccountService = MockAccountService()
    val mockViewModel = SignInViewModel(
